      ...
      <div className="container px-4 md:px-6 max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h3 className="font-bold text-xl text-white mb-4">Organiza Gabinete</h3>
            <p className="text-sm">
              Simplifique a gestão do seu gabinete com nossa plataforma de agendamento inteligente.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="mailto:contato@organizagabinete.com" className="hover:text-white">Contato</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2025 Organiza Gabinete. Todos os direitos reservados.</p>
